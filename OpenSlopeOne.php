...
class OpenSlopeOne
{
    ...
    private function _initSlopeOneTableByPHP()
    {
        ...
        {
            $slopeOneSql = 'insert into slope_one (select a.item_id as item_id1,b.item_id as item_id2,count(*) as times, sum(a.rating-b.rating) as rating from user_ratings a,user_ratings b where a.item_id = '
                         . $itemId
    ...
    {
        $sql = 'select s.item_id2 from slope_one s,user_ratings u where u.user_id = '
             . $userId
